...
public class EulerTest {
    ...
    @Test
    void testP024() {
        Assertions.assertEquals("2783915460", new P024().run());
    }

    @Test
    void testP025() {
        Assertions.assertEquals("4782", new P025().run());
    }
    ...
    @Test
    void testP029() {
        Assertions.assertEquals("9183", new P029().run());
    }

    @Test
    void testP030() {
        Assertions.assertEquals("443839", new P030().run());
    }

    @Test
    void testP031() {
        Assertions.assertEquals("73682", new P031().run());
    }

    @Test
    void testP032() {
        Assertions.assertEquals("45228", new P032().run());
    }
    ...
    @Test
    void testP035() {
        Assertions.assertEquals("55", new P035().run());
    }

    @Test
    void testP036() {
        Assertions.assertEquals("872187", new P036().run());
    }
